...
function createPluginRegistryFixture() {
  const plugins = [
    ...
    pluginFixture("plugin-manager", "Plugin Manager", "core", "settings", "Install, create, reload, enable, disable, and inspect Habbpy plugins.", true),
  ...
  return {
    ...
    userPluginRoot: "mock://appdata/HabbpyV4/plugins",
    portablePluginRoot: "mock://portable/HabbpyV4/plugins",
    loadErrors: [],
